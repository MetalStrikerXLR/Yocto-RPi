...
PACKAGECONFIG ??= "aplay cli hcitop ofono debug rfcomm  ${@bb.utils.filter('DISTRO_FEATURES', 'systemd', d)}"
...
FILES_${PN}-staticdev += "${libdir}/alsa-lib/*"
...
SYSTEMD_BLUEALSA_ARGS ?= "-p hfp-ofono -p a2dp-sink"
